...
Нужен компилятор с C++23 и `<expected>`: **GCC ≥ 13**, **Clang ≥ 16 с libc++**
или AppleClang ≥ 15. См.
[поддержку C++23 компиляторами](https://en.cppreference.com/w/cpp/compiler_support/23).
